...
const GoogleAuth = ({ queryClient, children }) => {
  ...
  return (
    <button
      ...
      className="w-full flex items-center justify-center ring-1 ring-neutral-300 text-neutral-900 shadow-md hover:bg-neutral-100 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center"
    >
